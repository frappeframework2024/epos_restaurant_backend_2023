...
def get_columns(filters):
	return [
		{"label":"Doc. #", "fieldname":"name","fieldtype":"Link","options":"Purchase Order Payment", "align":"center"},
		...
		{"label":"Reference", "fieldname":"referance","fieldtype":"Data","align":"left"},
  		{"label":"Purchase Order", "fieldname":"purchase_order","fieldtype":"Link","options":"Purchase Order","align":"left"},
		{"label":"Branch", "fieldname":"business_branch","fieldtype":"Data","align":"left","width":120},
		{"label":"Stock Location", "fieldname":"stock_location","fieldtype":"Data","align":"left","width":120},
		...
		{"label":"PO Amt", "fieldname":"purchase_order_amount","fieldtype":"Currency","align":"right","width":100},
...
def get_conditions(filters,group_filter=None):
	...
	if filters.get("purchase_order"):
		conditions += " AND a.purchase_order = %(expense)s"
...
def get_report_data(filters,parent_row_group=None,indent=0,group_filter=None):
	...
	sql = """select  
			...
			a.purchase_order_amount,
			a.payment_type,
			a.balance,
   			a.payment_amount
		FROM `tabPurchase Order Payment` AS a
		WHERE
			{}
...
def get_report_summary(data,filters):
	report_summary = []
	report_summary.append({"label":_("Purchase Order Amount"),"value":frappe.utils.fmt_money(Enumerable(data).sum(lambda x: x.purchase_order_amount or 0)),"indicator":"blue"})	
