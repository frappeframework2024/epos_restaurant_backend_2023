...
def get_row_groups():
  ...
  {
			"fieldname":"concat(a.expense_code,'-', a.expense_name)",
			"label":"Expense Code",
			"parent_row_group_filter_field":"row_group"
		},
		{
		...
		{
			"fieldname":"if(ifnull(b.vendor_code,'')='','Not Set',concat(b.vendor_code,'-',b.vendor_name))",
			"label":"Vendor",
			"parent_row_group_filter_field":"row_group"
		},
  	{
			"fieldname":"if(ifnull(b.vendor_group,'')='','Not Set',b.vendor_group)",
			"label":"Vendor Group",
			"parent_row_group_filter_field":"row_group"
		},
		{
  ...
  {
			"fieldname":"concat(b.expense_by,'-',b.employee_name)",
			"label":"Employee",
			"parent_row_group_filter_field":"row_group"
		}
	]