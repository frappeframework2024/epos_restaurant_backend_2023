<template>
    <div class="exchage-rate-st px-4 py-2">
        <div class="flex justify-between h-100 items-center">
            <div>
                <div class="svg-container">
                    <svg fill="#fff" height="40" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 611.994 611.994" xml:space="preserve">
