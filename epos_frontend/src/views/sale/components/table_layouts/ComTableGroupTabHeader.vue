        ...
        <v-row no-gutters>
            ...
            <v-col style="width: 1px;" cols="12" :md="tableSaleColor ? '6' : '12'" :lg="!mobile && tableSaleColor ? '4' : '12'">
                <v-tabs show-arrows align-tabs="center" height="100%" v-model="tableLayout.tab" center-active>
                    <v-tab :class="tableLayout.tab == g.key ? 'text-green' : ''" :style="{'text-transform': 'none !important', 'font-weight': tableLayout.tab == g.key ? 'bold' : '', 'font-family':'Khmer OS Siemreap'}" v-for="g in tableLayout.table_groups" :key="g.key"
