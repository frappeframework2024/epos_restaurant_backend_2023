<template>
    <ComModal :mobileFullscreen="true" @onClose="onClose()" width="1200px" :hideOkButton="true">
      <template #title>
        ...
        <span v-if="reservationDetail">
          ...
          <v-chip
            ...
            label
            variant="flat"
            :color="reservationDetail.reservation_status_background_color"
          >
      ...
      <template #content>
        <ComPlaceholder :loading="isLoading" :is-not-empty="reservationDetail"
                    ...
                    <v-card elevation="0"  rounded="0">
                      ...
                      <table class="w-full" border="1">
                        <tbody>
                            ...
                            <tr>
                                <th class="text-left">{{$t('Table')}}</th>
                                <td>{{ reservationDetail.table_number }}</td>
                            ...
                            <tr>
                                ...
                                <td><CurrencyFormat :value="reservationDetail.total_amount"  /> </td>
                                
                                
                            </tr>
                            <tr v-if="reservationDetail.total_deposit > 0">
                                <th class="text-left">{{$t('Total Deposit')}}</th>
                                <td ><CurrencyFormat :value="reservationDetail.total_deposit"  /> </td>
