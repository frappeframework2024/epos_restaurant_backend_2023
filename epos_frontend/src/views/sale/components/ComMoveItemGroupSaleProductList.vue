<template>
    <ComPlaceholder :is-not-empty="sale.getReSendSaleProducts().length > 0" icon="mdi-cart-outline"
        :text="$t('Empty Data')">
        <div>
        ...
        moment(g.order_time).format('HH:mm:ss')
                ...
                <ComMoveItemSaleProductList :group-key="g" />
            </span>
        </div>
    </ComPlaceholder>
</template>
...
import ComMoveItemSaleProductList from './ComMoveItemSaleProductList.vue';
