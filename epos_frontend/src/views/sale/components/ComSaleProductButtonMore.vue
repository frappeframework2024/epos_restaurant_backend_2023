<template >
    <v-menu>
        ...
        <v-list>
            <v-list-item prepend-icon="mdi-pencil" :title="$t('Edit')" v-if="!saleProduct.is_open_product && !saleProduct.is_timer_product &&  !(sale.setting.pos_setting.allow_change_quantity_after_submit == 1 || saleProduct.sale_product_status == 'Submitted')"
