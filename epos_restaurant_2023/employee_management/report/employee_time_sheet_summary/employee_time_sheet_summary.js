...
frappe.query_reports["Employee Time Sheet Summary"] = {
	...
	"formatter": function(value, row, column, data, default_formatter) {	
		...
		if (column.fieldname=="employee_name") {
			value = $(`<span><a onclick="epos_restaurant_2023.employee_time_sheet_summary.open_report('${value}')" href='/printview?doctype=Employee&name=${value}&format=Employee%20Time%20Sheet&no_letterhead=1&letterhead=No%20Letterhead&settings=%7B%7D&_lang=en'>${value}</a></span>`);
