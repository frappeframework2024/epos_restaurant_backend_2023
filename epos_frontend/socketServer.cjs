...
io.on('connection', (socket) => {
  ...
  socket.on("RefreshTable",(arg = {})=>{
    io.emit("RefreshTable",arg)
  })

   


  socket.on("ShowOrderInCustomerDisplay",(arg,show_thank_you = "", key)=>{
  
    io.emit("ShowOrderInCustomerDisplay",arg, show_thank_you,key)
  })
